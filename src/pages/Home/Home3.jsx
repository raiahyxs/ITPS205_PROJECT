    ...
    return (
        ...
        ">
            ...
            >
                ...
                <div className='txt-content flex flex-col gap-4 text-center lg:text-right'>
                    <h1 className='
                        text-4xl sm:text-5xl lg:text-6xl
                        font-montserrat font-bold leading-tight
                    '>
                        Easily see nearby places to go
                    </h1>
                    <h2 className="
                        ...
                        dark:text-gray-200
                    ">
                        Choose the best place to eat and visit based on the locations you selected for your trip
                    </h2>
                </div>
            </div>
        </div>
